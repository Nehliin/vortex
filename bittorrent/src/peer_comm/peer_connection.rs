    ...
    pub fn handle_message(
        ...
        match peer_message {
            ...
            PeerMessage::Unchoke => {
                ...
                if let Some((file_and_info, torrent_state)) = state.state() {
            ...
            PeerMessage::AllowedFast { index } => {
                ...
                if index < 0 && valid_range {
                    ...
                    if let Some((file_info, torrent_state)) = state.state() {
            ...
            PeerMessage::Piece { index, begin, data } => {
                let Some((read_state, torrent_state)) = state.state() else {
                    log::error!(
